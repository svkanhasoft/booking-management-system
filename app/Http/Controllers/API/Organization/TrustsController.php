...
class TrustsController extends Controller
{
    ...
    function add(Request $request)
    {
        $validator = Validator::make($request->all(), [
            ...
            'payable_day_rate' => 'required|numeric|gt:0',
            'payable_night_rate' => 'required|numeric|gt:0',
            'payable_saturday_rate' => 'required|numeric|gt:0',
            'payable_holiday_rate' => 'required|numeric|gt:0',
            'chargeable_day_rate' => 'required|numeric|gt:0',
            'chargeable_night_rate' => 'required|numeric|gt:0',
            'chargeable_saturday_rate' => 'required|numeric|gt:0',
            'chargeable_holiday_rate' => 'required|numeric|gt:0',
