...
<body class="clean-body" style="margin: 0; padding: 0; -webkit-text-size-adjust: 100%;border: 10px solid #f9f9f9; background-color: #F9F9F9;border-color:1px solid #CACACA;">
    <table class="nl-container" style="table-layout: fixed; vertical-align: top;margin-bottom: 20px; min-width: 320px; Margin: 0 auto; border-spacing: 0; border-collapse: collapse; mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #F9F9F9; width: 100%;" cellpadding="0" cellspacing="0" role="presentation" width="100%" bgcolor="#F9F9F9" valign="top">
        <tbody>
                                    ...
                                    <div style="width:100% !important;">
                                        <div style="border-top:0px solid transparent; border-left:0px solid transparent; border-bottom:0px solid transparent; border-right:0px solid transparent; padding-top:10px; padding-bottom:10px; padding-right: 0px; padding-left: 0px;">
                                            <div class="img-container center  autowidth  fullwidth" align="center" style="padding-right: 0px;padding-left: 0px;">
                                                <img class="center  autowidth  fullwidth" align="center" border="0" src="http://backendbooking.kanhasoftdev.com/uploads/logo.png" alt="Image" title="Image" style="text-decoration: none; -ms-interpolation-mode: bicubic; border: 0; height: auto; display: block;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div style="border-collapse: collapse;display: table;width: 100%;background-color:#;">
                                                <p class="MsoNormal" style="line-height:145%">
                                                    <span style="font-size:12pt;line-height:145%;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-fareast-font-family:&quot;Times New Roman&quot;;color:#37424A">Dear
                                                        {{ $details['data']['first_name']}} {{$details['data']['last_name'] }} <br>
                                                    </span>
                                                </p>
                                                ...
                                                Candidate applied in your shift</span>
                                                </p>
                                                <p class="MsoNormal" style="line-height:145%">
                                                ...
                                                <p class="MsoNormal" style="line-height:145%">
                                                    <span style="font-size:12pt;line-height:145%;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-fareast-font-family:&quot;Times New Roman&quot;;color:#37424A">Hospital Name:
                                                        {{ $details['data']['hospital_name'] }} <br></span>
                                                </p>
                                                <p class="MsoNormal" style="line-height:145%">
                                                    <span style="font-size:12pt;line-height:145%;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-fareast-font-family:&quot;Times New Roman&quot;;color:#37424A">Ward Name:
                                                        {{ $details['data']['ward_name'] }} <br></span>
                                                </p>
                                                <p class="MsoNormal" style="line-height:145%">
                                                    <span style="font-size:12pt;line-height:145%;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-fareast-font-family:&quot;Times New Roman&quot;;color:#37424A">Ward Type:
                                                ...
                                                <p class="MsoNormal" style="line-height:145%">
                                                    <span style="font-size:12pt;line-height:145%;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-fareast-font-family:&quot;Times New Roman&quot;;color:#37424A">Ward Type:
                                                        {{ date('H:i', strtotime($details['data']['start_time']))  }} <br></span>
                                                </p>
                                                <p class="MsoNormal" style="line-height:145%">
                                                    <span style="font-size:12pt;line-height:145%;font-family:&quot;Arial&quot;,&quot;sans-serif&quot;;mso-fareast-font-family:&quot;Times New Roman&quot;;color:#37424A">Rate:
                                                        {{ date('H:i', strtotime($details['data']['end_time']))  }} <br></span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
